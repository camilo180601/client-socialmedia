...
const Likes = () => {
    ...
    const getPublications = async (nextPage = 1) => {
        ...
        const request = await fetch(Global.url + "like/list/" + params.userId + "/" + nextPage, {
            method: "GET",
            headers: {
        ...
        if (data.status === "success") {
            ...
            let pubLikes: Array<any> = [];

            data.publicationsLikes.forEach((publicationlike: any) => {
                pubLikes = [...pubLikes, publicationlike.publication]
            })

            data.publications = pubLikes;
        ...
        <div className='w-full mx-auto items-center'>
            <div className='flex m-5'>
                ...
                <div className='flex-col text-left'>
                    ...
                    <h5 className='text-small text-default-400'>{likes.length} Me gusta</h5>
                </div>
            </div>
            <header className="w-full items-center mt-5 ml-30">
